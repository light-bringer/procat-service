...
func (x *Product) GetDiscountPercent() int64 {
...
type ApplyDiscountRequest struct {
	state           protoimpl.MessageState `protogen:"open.v1"`
	ProductId       string                 `protobuf:"bytes,1,opt,name=product_id,json=productId,proto3" json:"product_id,omitempty"`
	DiscountPercent int64                  `protobuf:"varint,2,opt,name=discount_percent,json=discountPercent,proto3" json:"discount_percent,omitempty"`
...
func (x *ApplyDiscountRequest) GetDiscountPercent() int64 {
	if x != nil {
		return x.DiscountPercent
	}
	return 0
...
const file_proto_product_v1_product_service_proto_rawDesc = "" +
	...
	"\vdenominator\x18\x02 \x01(\x03R\vdenominator\"\xbe\x03\n" +
	"\aProduct\x12\x1d\n" +
	"\n" +
	...
	"\x10discount_percent\x18\a \x01(\x03H\x00R\x0fdiscountPercent\x88\x01\x01\x12'\n" +
	...
	"\x10discount_percent\x18\x02 \x01(\x03R\x0fdiscountPercent\x129\n" +
	"\n" +
